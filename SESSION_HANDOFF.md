...
- **Model:** rent for the weekend / buy forever / **rent-to-own** (50% of paid rent credits toward purchase, capped at one event's rent; example on site: $150 rent → keep for $395 − $75 = $320). Built to order only: 50% deposit (≥ materials ×1.25) books the date, non-refundable once cut / inside 60 days. Wording approved in writing + free proof before cutting. Refundable damage deposit $100 or 25% on rentals. Delivery/setup/pickup $95 flat ≤25 mi then $2/mi; radius extended for mountain venues; large builds never ship. Balance due at delivery, invoiced via Square. **$50 date hold** payable on the website, credited to balance, refundable 7 days.
...
01 The Arched Welcome (arched-welcome) rent $125 / buy $395, RTO · 02 Seating Chart Wall (seating-chart-wall) rent $275, first 100 names incl. then $1/name · 03 The Family Round (family-round) buy $375 · 04 Champagne Wall (champagne-wall) rent $225 · 05 Unplugged Ceremony (unplugged-ceremony) rent $45 · 06 The Bar Menu (bar-menu) rent $75 · 07 Grand Arch Welcome Wall (grand-arch-welcome-wall) rent $350 / buy $995, RTO · 08 Ceremony Arch Set (ceremony-arch-set) rent $425/set · 09 Slat Monogram Backdrop (slat-backdrop) rent $375 · 10 The Mobile Bar (mobile-bar) rent $425. Package (welcome+seating+3 small) $495–750 · small signs $35–65. (Repriced 2026-07-20 to ~$100/hr labor after materials.) Premium pricing tier unlocks after ~15–20 reviewed events. Never quote below ~50–55% gross margin.
