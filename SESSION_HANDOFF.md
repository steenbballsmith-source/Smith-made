...
- **Model:** rent for the weekend / buy forever / **rent-to-own** (50% of paid rent credits toward purchase, capped at one event's rent; example on site: $95 rent → keep for $250 − $47 = $203). Built to order only: 50% deposit (≥ materials ×1.25) books the date, non-refundable once cut / inside 60 days. Wording approved in writing + free proof before cutting. Refundable damage deposit $100 or 25% on rentals. Delivery/setup/pickup $75 flat ≤25 mi then $2/mi; radius extended for mountain venues; large builds never ship. Balance due at delivery, invoiced via Square. **$50 date hold** payable on the website, credited to balance, refundable 7 days.
...
01 The Arched Welcome (arched-welcome) rent $75 / buy $195, RTO · 02 Seating Chart Wall (seating-chart-wall) rent $125, first 100 names incl. then $0.75/name · 03 The Family Round (family-round) buy $225 · 04 Champagne Wall (champagne-wall) rent $150 · 05 Unplugged Ceremony (unplugged-ceremony) rent $25 · 06 The Bar Menu (bar-menu) rent $35 · 07 Grand Arch Welcome Wall (grand-arch-welcome-wall) rent $225 / buy $550, RTO · 08 Ceremony Arch Set (ceremony-arch-set) rent $295/set · 09 Slat Monogram Backdrop (slat-backdrop) rent $250 · 10 The Mobile Bar (mobile-bar) rent $275. Package (welcome+seating+3 small) $350–550 · small signs $20–40. Premium pricing tier unlocks after ~15–20 reviewed events. Never quote below ~50–55% gross margin.
