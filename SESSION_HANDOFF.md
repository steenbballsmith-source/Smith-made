...
- **Model:** primarily a RENTAL company — rent for the weekend, custom pieces built to order by quote. Rent-to-own is dead: removed from every public material 2026-07-22 per Will, do not reintroduce. 50% deposit books the date and holds the pieces, non-refundable inside 60 days. Wording approved in writing + free proof before anything is made. Refundable damage deposit $100 or 25% on rentals. Delivery and pickup a flat $125 ≤25 mi — the per-mile figure is off the site (2026-07-30); couples can collect and return themselves for less. WE DO NOT STYLE OR SET UP AT THE VENUE — the couple does; large builds never ship. Balance due at delivery, invoiced via Square. **$50 date hold** payable on the website, credited to balance, refundable 7 days.
...
01 The Arched Welcome (arched-welcome) rent $175 / buy $1,450 · 02 Seating Chart Wall (seating-chart-wall) rent $375 · 03 The Family Round (family-round) buy $495 · 04 Champagne Wall (champagne-wall) rent $325 · 05 Grand Arch Welcome Wall (grand-arch-welcome-wall) rent $495 / buy $3,850 · 06 Ceremony Arch Set (ceremony-arch-set) rent $595/set · 07 Slat Monogram Backdrop (slat-backdrop) rent $525 · 08 The Mobile Bar (mobile-bar) rent $595. 2026-07-30: Unplugged Ceremony and Bar Menu RETIRED per Steen; catalog renumbered 01-08; the packages/add-ons table is gone, replaced by a pickup-savings callout; buy prices raised hard because the statement pieces stay in the rental rotation (buying = a commission). Delivery is a flat $125 within 25 miles; the per-mile line is off the site. Personalisation goes on a SEPARATE engraved plaque — never cut into a rental. Premium pricing tier unlocks after ~15–20 reviewed events. Never quote below ~50–55% gross margin.
